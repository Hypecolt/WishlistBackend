...
router.put("/", authMiddleware, urlencodedParser, itemToWishlistController.updateItemFromWishlist);
router.delete("/", authMiddleware, urlencodedParser, itemToWishlistController.deleteItemFromWishlist);
